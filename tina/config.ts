    ...
    collections: [
      // ─── EVENTS (Swedish) ────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: 'string', name: 'cost', label: 'Kostnad (t.ex. Kostnadsfritt)' },
          { type: 'string', name: 'duration', label: 'Omfattning (t.ex. "Fem träffar á tre timmar")' },
          { type: 'string', name: 'deadline', label: 'Sista anmälningsdag (t.ex. "Fredag 18 september")' },
      ...
      // ─── EVENTS (English) ────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: 'string', name: 'duration', label: 'Duration (e.g. "Five sessions of three hours")' },
          { type: 'string', name: 'deadline', label: 'Deadline (e.g. "Friday 18 September")' },
